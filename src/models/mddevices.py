...
class Device(db.Model):
    ...
    charger = db.Column(db.String(200), nullable=False)
    device_serial = db.Column(db.String(200), nullable=True, unique=True)
    model = db.Column(db.String(200), nullable=False)
    activo= db.Column(db.String(200), nullable= False, unique= True)
    serie= db.Column(db.String(200), nullable= False, unique= True)
    processor = db.Column(db.String(200), nullable= False,)
    RAM = db.Column(db.String(200),nullable=False)
    hard_disk= db.Column(db.String(200),nullable=False)
    type_equipment = db.Column(db.String(200),nullable=False)
